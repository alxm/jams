...
void z_controls_load(void)
{
    ...
    z_controls.secondary = a_button_new("key.x gamepad.b.x");
    z_controls.start = a_button_new("key.enter gamepad.b.start");
}
...
void z_controls_release(void)
{
    ...
    a_button_release(z_controls.primary);
    a_button_release(z_controls.secondary);
    a_button_release(z_controls.start);
}
