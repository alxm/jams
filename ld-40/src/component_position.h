...
extern void z_comp_position_getCoordsFix(const ZCompPosition* Position, AFix* X, AFix* Y);
extern void z_comp_position_getCoordsInt(const ZCompPosition* Position, int* X, int* Y);
