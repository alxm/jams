...
struct ZCompMap {
    ...
    AEntity* entities[Z_MAP_TILES_H][Z_MAP_TILES_W];
};
...
AEntity* z_comp_map_getTileEntity(ZCompMap* Map, int X, int Y)
{
    return Map->entities[Y][X];
}

void z_comp_map_setTileEntity(ZCompMap* Map, int X, int Y, AEntity* Entity)
{
