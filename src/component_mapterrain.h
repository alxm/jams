...
extern void z_comp_mapterrain_getDim(const ZCompMapTerrain* Terrain, int* W, int* H);
extern ZUtilTerrainType z_comp_mapterrain_getType(const ZCompMapTerrain* Terrain, int X, int Y);
